...
public class MapMenu : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        mapImage.rectTransform.sizeDelta = new Vector2(Screen.width, Screen.height);
        canvasScaler.referenceResolution = new Vector2(Screen.width, Screen.height);
        buildingsRectTransform.sizeDelta = new Vector2(Screen.width, Screen.height);

        //percentage of the mouse position based on screen size
        markerText.transform.position = Input.mousePosition;
        var mouseScreenPercentage = new Vector3(Input.mousePosition.x / Screen.width, Input.mousePosition.y / Screen.height);
        ...
        var mapTotalHeight = (canvasScaler.referenceResolution.y + canvasScaler.referenceResolution.y * (zoomLevels[currentZoom] - 1));
